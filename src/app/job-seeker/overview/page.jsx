        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a href="#" className="text-text-secondary hover:text-primary-300 transition-colors font-medium">
                Pelatihan & Skil
              </a>
              <a href="#" className="text-text-secondary hover:text-primary-300 transition-colors font-medium">
                Komunitas
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <h1 className="text-3xl font-bold text-text-primary">Job Details</h1>
            <div className="w-full md:w-auto flex items-center gap-2">
              <form onSubmit={handleSearch} className="flex-1 md:flex-initial flex items-center bg-gray-50 rounded-md border border-gray-300 p-2 min-w-[300px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-card rounded-lg shadow-md p-6 border border-gray-200">
              <h2 className="text-3xl font-bold text-text-primary mb-2">{jobData.title}</h2>
              <p className="text-lg text-text-secondary mb-6">{jobData.company}</p>
            ...
            {/* Job Overview */}
            <div className="bg-card rounded-lg shadow-md p-6 border border-gray-200">
              <h3 className="text-xl font-bold text-text-primary mb-6">Job Overview</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-text-primary font-semibold">{jobData.postedDate}</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 text-text-secondary">
                  ...
                  <p className="text-text-primary font-semibold">{jobData.expireDate}</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 text-text-secondary">
                  ...
                  <p className="text-text-primary font-semibold">{jobData.education}</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 text-text-secondary">
                  ...
                  <p className="text-text-primary font-semibold">{jobData.salary}</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 text-text-secondary">
                  ...
                  <p className="text-text-primary font-semibold">{jobData.location}</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 text-text-secondary">
                  ...
                  <p className="text-text-primary font-semibold">{jobData.jobType}</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 text-text-secondary">
                    <Briefcase className="w-5 h-5 text-primary-300" />
                  ...
                  <p className="text-text-primary font-semibold">{jobData.experience}</p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 text-text-secondary">
                  ...
                  <p className="text-text-primary font-semibold">{jobData.disability}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Job Description */}
            <div className="bg-card rounded-lg shadow-md p-6 border border-gray-200">
              <h3 className="text-xl font-bold text-text-primary mb-4">Deskripsi Pekerjaan</h3>
              <p className="text-text-secondary leading-relaxed mb-4">{jobData.description}</p>
              <p className="text-text-secondary leading-relaxed">{jobData.description}</p>
            </div>

            {/* Responsibilities */}
            <div className="bg-card rounded-lg shadow-md p-6 border border-gray-200">
              <h3 className="text-xl font-bold text-text-primary mb-4">Tanggung Jawab / Jobdesck</h3>
            ...
            <div className="bg-card rounded-lg shadow-md p-6 border border-gray-200">
              <h3 className="text-lg font-medium text-text-primary mb-4">Media Sosial Perusahaan</h3>
          ...
          <div className="space-y-6">
            {jobData.reviews.map((review, index) => (
              <div key={index} className="border-b border-gray-200 pb-6 last:border-b-0 last:pb-0">
                ...
                <p className="text-text-secondary leading-relaxed mb-3">{review.text}</p>
